...
| grouping      | Array         | Array yang menentukan pengaturan pengelompokan untuk data yang diekspor. Setiap elemen array merupakan kolom atau properti berdasarkan mana data akan dikelompokkan. |
| Example usage | ["no_faktur"] | Contoh penggunaan: Untuk mengelompokkan data berdasarkan nomor faktur, gunakan array ["no_faktur"]. Ini akan menyusun data dalam kelompok berdasarkan nomor faktur.  |
